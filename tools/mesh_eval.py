...
def read_and_downsample_pcd_from_mesh(path, pbar, thresh=0.001, scale=1, coord_trans=False, USE_O3D=False):
    if USE_O3D:
        import open3d as o3d
...
def eval_chamfer_distance(pred_path, gt_path, gt_scale, eval_dir, suffix='', runtime=False, vis=False,
    max_dist = 0.1):
