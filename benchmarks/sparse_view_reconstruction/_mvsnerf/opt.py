...
def config_parser(cmd=None):
    ...
    parser.add_argument('--use_testsub', action='store_true')
    ...
    parser.add_argument('--dataset_name', type=str, default='oo3d',
                        choices=['dtu', 'blender', 'llff', 'dtu_ft', 'oo3d', 'oo3d_ft', 'oo3d_testsub'])
