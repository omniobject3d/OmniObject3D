...
if __name__ == '__main__':
    ...
    out_scene_dir = os.path.join(extra_out_dir, '{:06d}'.format(model.start_step))
    ...
    for i, data in enumerate(test_loader):
        ...
        with torch.no_grad():
            ...
            imageio.imwrite(os.path.join(out_scene_dir, '{0}_{1}_gt_rgb.png'.format(os.path.basename(args.datadir), i)), gt_rgb_np_uint8)
            ...
            imageio.imwrite(os.path.join(out_scene_dir, '{0}_{1}_pred_fine.png'.format(os.path.basename(args.datadir), i)), fine_pred_rgb)
